---
layout: post
title: "My prompt folder had a name before I knew it"
...
description: "SPDD gave a name to a habit I had already been building: treating prompts as version-controlled architecture artifacts. The prompt is becoming the place where implementation design gets captured — not the chat tab where it disappears."
...
*[ClearRank](https://clearrank.io) tracks how AI search tools describe your company and flags when that description drifts from your intended positioning. Reach out if you want to follow along — I am opening early access soon.*
